...
class TestSequence(unittest.TestCase):
    def test_sequence(self):
        ...
        with sq:
            ...
            Sequence.add('SECOND', SimpleActionState('reference_action',TestAction, goal = g2))
            Sequence.add('THIRD', SimpleActionState('reference_action',TestAction, goal = g3),{'succeeded':'done'})
        outcome = sq.execute()
